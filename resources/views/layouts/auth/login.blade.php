        ...
        <section class="login-card-shell" aria-label="Login Bella System">
            <div class="login-box">
                ...
                <div class="login-welcome">
                    <div class="login-logo-text">Welcome Back</div>
                ...
                <form method="POST" action="{{ route('login.auth') }}" class="login-form-panel needs-validation"
                    novalidate>
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input id="npk" type="text" class="form-control @error('npk') is-invalid @enderror"
                            name="npk" tabindex="1" required autofocus autocomplete="off" placeholder="Masukkan NPK">
                        @error('npk')
                    ...
                    <button type="submit" class="btn btn-primary login-submit" tabindex="4" id="login">
                        <span>Login</span>
