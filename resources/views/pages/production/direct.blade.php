...
@section('main')
    ...
    {{-- modal scan loading list --}}
    <div class="modal fade" id="modalLoadingListScan" tabindex="-1" role="dialog"
        aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="border-radius: 12px !important;">
        <div class="modal-header">
            <h5 class="modal-title"><b>Scan Loading List</b></h5>
        </div>
        <div class="modal-body">
            <p class="mb-2 text-muted">Silakan scan barcode Loading List terlebih dahulu.</p>
            <input type="text" class="form-control" id="input-ll" placeholder="scan loading list..."
                autocomplete="off" autofocus>
            <small class="text-muted d-block mt-2">
            *Halaman tidak bisa digunakan sebelum Loading List tervalidasi.
            </small>
        </div>
        </div>
    </div>
    </div>
    {{-- end modal scan loading list --}}
